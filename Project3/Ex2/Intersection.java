...
public class Intersection {
	public static void main(String[] args) {
        ...
        p_04n.SetName("p_04n");
        p_04n.Value = new TransferOperation("localhost","1080", "p5"); //??????
        ...
        Condition T9Ct1 = new Condition(t_g1e,"p_01e",TransitionCondition.HaveCar);
        ...
        Condition T10Ct1 = new Condition(t_g2e,"p_02e",TransitionCondition.HaveCar);
        ...
        Condition T11Ct1 = new Condition(t_g3e,"p_03e",TransitionCondition.HaveCar);
        ...
        Condition T12Ct1 = new Condition(t_g4e,"p_04e",TransitionCondition.HaveCar);
		...
		grdT13.Activations.add(new Activation(t_g4n,"p_04n", TransitionOperation.SendOverNetwork,"p_04e"));
