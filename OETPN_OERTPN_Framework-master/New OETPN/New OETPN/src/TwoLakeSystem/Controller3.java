...
public class Controller3 {
	public static void main(String[] args) {
     ...
     // -------Sub guard 1---------
     		...
     		grdT0.Activations.add(new Activation(t0, "hr2", TransitionOperation.Move, "hr3"));
     	...
     	// -------Sub guard 2---------
    		...
    		grdT02.Activations.add(new Activation(t0, "hr2", TransitionOperation.Move, "hr3"));
    		...
    		grdT03.Activations.add(new Activation(t0, "hr2", TransitionOperation.Move, "hr3"));
    		...
    		grdT04.Activations.add(new Activation(t0, "hr2", TransitionOperation.Move, "hr3"));
    		...
    		grdT05.Activations.add(new Activation(t0, "hr2", TransitionOperation.Move, "hr3"));
